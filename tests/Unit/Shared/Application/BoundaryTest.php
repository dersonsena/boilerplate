...
class BoundaryTest extends TestCase
{
    ...
    {
        $this->expectException(InvalidUseCaseParamException::class);
        $this->expectExceptionMessage("Invalid use case param: it couldn't get the property 'invalidProp' because it doesn't exist in the Boundary '". BoundaryBase::class ."'");
    ...
    {
        $this->expectException(InvalidUseCaseParamException::class);
        $this->expectExceptionMessage("Invalid use case param: you cannot change the property 'stringProp' of the Boundary '". BoundaryBase::class ."' because it is read-only.");
